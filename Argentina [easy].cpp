...
You have both, but you want to make sure you pay the lower price! Do you pay in Dollars or Pesos? The exchange rate is 2 cents for every Peso.
...
int main() {
    ...
    int PesoCalculatedtoUSD = Pesos * 0.02;

    if (PesoCalculatedtoUSD > Dollars) {
        cout << "Dollars";
    }
    else if (Dollars > PesoCalculatedtoUSD) {
        cout << "Pesos";
    }
    return 0;
}